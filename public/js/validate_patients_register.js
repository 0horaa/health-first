...
const feedbackFromSocialName = document.querySelector("#feedback-from-social-name");
...
function handleWithGeneralChecks() {
    ...
    if(someInputIsEmpty(inputsFromPatients.socialName) || inputNameIsInsufficient(inputsFromPatients.socialName)) {
        feedbackFromSocialName.style.display = "block";
        feedbackFromSocialName.innerHTML = "Digite o nome social completo do paciente."
        feedbackFromSocialName.setAttribute("class", "invalid-feedback");
        hasEmptyInput = true;
    } else {
        feedbackFromSocialName.style.display = "block";
        feedbackFromSocialName.innerHTML = "Tudo certo."
        feedbackFromSocialName.setAttribute("class", "valid-feedback");
    }
